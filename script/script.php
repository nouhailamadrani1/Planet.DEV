      ...
      ?>
          <tr>
            ...
            <td> 
              ...
              <button type="button" name="delete" class="btn btn-danger " style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" ><a  class="text-decoration-none text-white"  href='../script/script.php?id=<?= $row['id']; ?>'>Delete</a>
              </button>
            </td>
          </tr>
        <?php }
